...
public class String {
    ...
    // modulo_1.String are sequence of Unicode characters. For example "Java/u1222" consists of the five Unicode characters
    // J, a, v, a and 'TM'. Java does not have a built-in string type.
    // Each quoted string is an instance of the modulo_1.String class:
    static void main() {
        ...
        // Isn't efficient if you see need to change the value all the time, you can use substring to create new modulo_1.String
        // But the real benefit is the new modulo_1.String using replace or substring for example, use the same Character points to the same location.
        ...
        Even java doing garbage collection automatic, modulo_1.String share the Characters to avoid peaks of Heap Memory.

        */

        /* Equality Tests */
        java.lang.String s = "Some string";
        java.lang.String b = "Other modulo_1.String";
