...
public class Exercise5 {
    ...
    /*
    1 - Escreva um código para enviar mensagens de marketing, para isso você
    ...
    Saude e bem estar, Vestuário e Cultura. Todos os produtos devem ter
    um método para retornar o seu valor de imposto, de acordo com seu tipo:
