...
/*
    ...
    devem ser criados os tipos Meia entrada e ingresso família. Cada ingresso deve ter um método que retorna
    o seu valor real ( baseado no valor informado na criação do ingresso) para os de meia entrada o seu valor
 ...
 */
public sealed class Ingresso permits MeiaEntrada, Familia{

    private double valor;
    private String nomeDoFilme;
    protected enum Linguagem { DUBLADO, LEGENDADO };
    private Linguagem linguagem;

    public Ingresso(double valor, String nomeDoFilme, Linguagem linguagem) {
        this.valor = valor;
